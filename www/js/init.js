...
$(function(){
  ...
  trackerAnalytics('Inicio aplicación')
...
/* GET FAVORITOS  */
  ...
  try{
    ...
    //   }catch(e){
    //     console.log('No se ha podido portar los favoritos')
    //   }
...
function trackerAnalytics(msg){
  try{
    //window.analytics.trackView(msg)
    ga('send', msg);


  }catch(e){

    console.log('No se ha podido enviar a Google Analytics la vista.')
  }
}

function trackerEventAnalytics(categoria,msg,etiqueta,valor){
  try{
      ga('send', 'event', categoria, msg);

  }catch(e){
    console.log('No se ha podido enviar a Google Analytics el evento.')
  }
